...
void plot_BDTScore(TString gp="VBFH", TString regime="Merged", TString mass="700A1000A2000A3000", TString op="allcomb"){

	TString fileName = gp + "_" + regime + "_SRCR_" + mass + op;
	
	TString method = "BDTG_" + gp + "_" + regime + "_SRCR_" + mass;
